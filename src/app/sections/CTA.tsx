...
export default function CTA() {
  ...
  return (
    <section id="contact" className="py-24 relative overflow-hidden bg-dark-secondary">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <h2 className="font-display text-4xl md:text-6xl font-bold mb-8 max-w-3xl mx-auto">
          Llevá tu infraestructura médica al
        ...
        <p className="text-xl text-light/70 mb-12 max-w-2xl mx-auto">
          Contactanos hoy para discutir cómo podemos optimizar sus sistemas de gases medicinales.
        </p>
